...
pub struct CustodianGetOrganisations200ResponseData {
    ...
    pub data: Option<Vec<models::Organisation>>,
...
impl CustodianGetOrganisations200ResponseData {
    pub fn new() -> CustodianGetOrganisations200ResponseData {
