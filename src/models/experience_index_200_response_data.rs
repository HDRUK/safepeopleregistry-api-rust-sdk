...
pub struct ExperienceIndex200ResponseData {
    ...
    pub data: Option<Vec<models::Experience>>,
...
impl ExperienceIndex200ResponseData {
    pub fn new() -> ExperienceIndex200ResponseData {
