...
pub struct OrganisationGetUsers200ResponseData {
    #[serde(rename = "current_page", skip_serializing_if = "Option::is_none")]
    pub current_page: Option<i32>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::OrganisationGetUsers200ResponseDataDataInner>>,
...
impl OrganisationGetUsers200ResponseData {
    pub fn new() -> OrganisationGetUsers200ResponseData {
